...
function answer(q){
  ...
  if(EN){
    ...
    if(/star|popular|difficult|rare/.test(n))return 'PSKŁ scale: popularity from 1 to 5 indicates recognition and market presence. Acquisition difficulty from 1 to 5 indicates rarity. A rating of 5/5 means that a good example is very difficult to find.';
...
function bindPirate(){
  ...
  pirate.setAttribute('title',EN?'PSKŁ Pirate, help, advice and verification':'Pirat PSKŁ — pomoc, doradzanie i weryfikowanie');
  return true;
}
