...
const ui={
  ...
  'Typ / zastosowanie':'Type / use','Oryginalny silnik / napęd':'Original engine / propulsion','PSKŁ · PROFIL KOLEKCJONERSKI':'PSKŁ · COLLECTOR PROFILE','Znaczenie i dostępność':'Significance and availability',
  ...
  'Cechy rozpoznawcze':'Distinguishing features','Wskazówka kolekcjonerska':'Collector guidance','Ocena kolekcjonerska PSKŁ ma charakter orientacyjny i porównawczy. Nie jest wyceną rynkową ani statystyką liczby istniejących egzemplarzy.':'The PSKŁ collector rating is indicative and comparative. It is not a market valuation or a count of surviving boats.',
  'Obserwowane i analizowane oferty':'Watched and analysed listings','OBSERWOWANE OFERTY':'WATCHED LISTINGS','wybrane w zakładce „Szukaj”':'selected in Search','Pozostałe oferty w indeksie PSKŁ':'Other listings in the PSKŁ index','bieżące i wcześniej zweryfikowane pozycje':'current and previously verified entries',
  ...
  'Księga Założycielska — Wydanie I':'Founding Book, First Edition','Otwórz Księgę':'Open the Book','Otwórz PDF':'Open PDF','Pobierz PDF':'Download PDF',
  ...
  'Udostępnij':'Share','Zainstaluj':'Install','Kopiuj link':'Copy link','Link skopiowany.':'Link copied.','Instalacja została anulowana.':'Installation cancelled.','PSKŁ zostało zainstalowane.':'PSKŁ has been installed.',
  ...
  'Rok niepodany':'Year not provided','Inny':'Other','Cena w ogłoszeniu':'Price in listing','Zdjęcie poglądowe':'Reference image','Zdjęcie z wyniku portalu':'Image from marketplace result','Brak zdjęcia w indeksie':'No image in the index'
