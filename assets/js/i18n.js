...
const ui={
  'Start':'Home','Stowarzyszenie':'Association','Katalog':'Catalogue','Oferty':'Listings','Szukaj':'Search','Oferty rynkowe':'Market listings','Wyszukiwanie':'Search','Księga':'Founding Book','Logo i instalacja':'Logo and installation','Dane kontaktowe':'Contact details','06 · DANE KONTAKTOWE':'06 · CONTACT DETAILS',
  'misja i cele':'mission and goals','modele i profile':'models and profiles','obserwowane i analiza':'watchlist and analysis','wyniki według filtrów':'filtered results','34 strony':'34 pages','udostępnij i instaluj':'share and install','telefon i email':'phone and email','Telefon':'Phone','Email':'Email','Założyciel':'Founder','Polskie Stowarzyszenie Zabytkowych i Klasycznych Łodzi oraz Tradycyjnego Szkutnictwa':'Polish Association of Antique and Classic Boats and Traditional Boatbuilding',
  ...
  '02 · KATALOG':'02 · CATALOGUE','03 · OFERTY':'03 · LISTINGS','04 · WYSZUKIWANIE OFERT':'04 · LISTING SEARCH','05 · KSIĘGA ZAŁOŻYCIELSKA':'05 · FOUNDING BOOK','Księga Założycielska — Wydanie I':'Founding Book, First Edition','Otwórz Księgę':'Open the Book','Otwórz PDF':'Open PDF','Pobierz PDF':'Download PDF',
...
if(association)association.innerHTML=`<div class="association-hero"><img src="assets/branding/pskl-tabliczka.webp" width="1659" height="948" alt="Metal plaque with the PSKL logo"><div><p class="eyebrow">01 · ASSOCIATION</p><h2>We protect stories written in wood.</h2><p>The Polish Association of Antique and Classic Boats and Traditional Boatbuilding is being established in Szczecin as an open community of boat owners, boatbuilders, craftspeople, sailors, historians and everyone interested in maritime heritage.</p><p class="association-motto">We protect heritage. We build tradition. We inspire the future.</p></div></div><div class="association-body"><div class="association-intro"><p class="eyebrow">OUR MISSION</p><h3>More than a love of boats brings us together.</h3><p>Every classic boat carries the history of people, places and craftsmanship. We want these stories to live, sail and inspire future generations.</p></div><div class="association-values"><article><span>01</span><h4>Heritage</h4><p>We protect the authenticity of boats and document their histories.</p></article><article><span>02</span><h4>Craftsmanship</h4><p>We promote traditional boatbuilding techniques and responsible restoration.</p></article><article><span>03</span><h4>Education</h4><p>We share knowledge through workshops, training and meetings.</p></article><article><span>04</span><h4>Community</h4><p>We connect enthusiasts, experts, institutions and partners in Poland and abroad.</p></article></div><div class="association-goals"><div><p class="eyebrow">OUR GOALS</p><h3>From protecting heritage to acting together.</h3></div><ul><li>Restoration, conservation and protection of classic and antique boats.</li><li>Documenting the history of boats, designers and traditional boatbuilding.</li><li>Workshops and education for young people, adults and boat owners.</li><li>Cooperation with museums, schools, experts and international organisations.</li><li>Promoting Szczecin and Poland as a home of living maritime heritage.</li></ul></div><div class="association-projects"><article><p class="eyebrow">A VISION FOR SZCZECIN</p><h3>Traditional Boatbuilding Centre</h3><p>Our long-term goal is to create a nationally and internationally recognised space for restoration, education, exhibitions and the exchange of knowledge.</p></article><article><p class="eyebrow">AN ANNUAL EVENT</p><h3>Classic Boat Festival Szczecin</h3><p>We are planning a celebration of classic boats and maritime culture, featuring a boat parade, craft demonstrations, expert meetings and a programme for families.</p></article></div><div class="association-join"><div><p class="eyebrow">JOIN US</p><h3>Your passion has a place here.</h3><p>You do not need to own a classic boat or be a professional boatbuilder. Curiosity, respect for heritage and a willingness to act together are what matter.</p></div><button class="button primary route" data-route="contact">Contact details</button></div></div>`;
