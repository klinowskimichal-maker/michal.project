...
# Browser atob() accepts unpadded Base64 in this payload; Python needs padding.
encoded += '=' * (-len(encoded) % 4)
raw = base64.b64decode(encoded)
if not raw.startswith(b'\x1f\x8b'):
    raise SystemExit('Founder Charter payload is not gzip data after Base64 decode')
